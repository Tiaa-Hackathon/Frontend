                        ...
                        <v-col cols="10" offset="1">
                            <!-- <v-card style="background-color: rgb(235, 235, 235);"> -->
                                ...
                                <v-row style="height: 10vh; margin-top: 3vh;">
                                    <v-col cols="12" >
                                        <v-text-field solo label="Password" hint="Enter your Password" v-model="password"></v-text-field>
                                    </v-col>
                                </v-row>
                    ...
                    <v-row style="margin-top: 3vh;">
                        <v-col cols="4" offset="1">
                            <v-btn block elevation="2" @click="submit()"
                                style="margin-top: 2vh; background-color: rgba(110, 0, 149, 1); color: white;">
                                SIGN IN
                            </v-btn>
                        </v-col>
                                    ...
                                    <v-card-text>
                                        <v-container>
                                            <v-row>
                                                ...
                                                <v-col cols="12" sm="6">
                                                    <v-text-field label="Confirm Password*" type="password" v-model="c_pass"
                                                        required></v-text-field>
                                                </v-col>
                                                <v-col cols="12" sm="6">
                                                ...
                                                <v-col cols="12">
                                                    <v-autocomplete
                                                        :items="['Science','Technology','Sports','Economics','Geopolitics', 'Environment', 'Business', 'Finance', 'Art', 'Culture','Others']"
                                                        label="Interests*" multiple required
